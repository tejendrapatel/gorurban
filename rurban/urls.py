...
####           dynamic urls       #######
    ...
    path('gallery_dynamics/<int:cmp_id>/', GALLERY_SINGLE, name='gallery_dynamics'),
    path('news_dynamics/<int:cmp_id>/', NEWS_SINGLE, name='news_dynamics'),
    path('events_dynamics/<int:cmp_id>/', EVENTS_SINGLE, name='events_dynamics'),
